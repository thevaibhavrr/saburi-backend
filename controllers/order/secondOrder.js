...
//   }
// };
// const createShiprocketOrder = async (orderData, token) => {
//   try {
...
//   //   sub_total: cart.orderItems.reduce(
//   //     (acc, item) => acc + item.singleProductPrice * item.quantity,
//   //     0
//   //   ),
//   // };

//   // const shiprocketResponse = await createShiprocketOrder(shiprocketOrderData, token);
...
//     paymentMethod,
//     paymentId,
//     // shiprocket_order: shiprocketResponse,
//   });
// });
